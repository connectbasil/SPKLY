...
export const MOCK_SURVEYS = [
  {
    ...
    survey_type: 'csat',
    intent: 'Understand where new customers get stuck in the first 30 days and what would make onboarding smoother.',
    audience: 'Customers',
    tone: 'Empathetic',
    scoring_enabled: true,
    custom_questions: ['How satisfied are you with your overall experience?', 'What could we improve?'],
    status: 'active',
  ...
  },
  {
    ...
    survey_type: 'nps',
    intent: 'Monthly NPS pulse to track promoter/detractor trends among active subscribers.',
    audience: 'Customers',
    tone: 'Casual',
    scoring_enabled: true,
    custom_questions: ['How likely are you to recommend us?', 'What is the main reason for your score?'],
    status: 'active',
    created_at: dateOffset(7),
  ...
  },
  {
    ...
    survey_type: 'csat',
    intent: 'Post-ticket survey to measure satisfaction with the support team and identify coaching opportunities.',
    audience: 'Customers',
    tone: 'Empathetic',
    scoring_enabled: true,
    custom_questions: ['How satisfied were you with the support you received?', 'What could we have done better?'],
    status: 'active',
    created_at: dateOffset(2),
...
export const MOCK_CONTACTS = [
  { id: 1, name: 'Priya Nair', email: 'priya@acme.com', phone: null, status: 'completed', invited_at: dateOffset(10), completed_at: dateOffset(8), created_at: dateOffset(10), survey_link: '/survey/demo-survey-001?c=1' },
  { id: 2, name: 'James Okafor', email: 'james@acme.com', phone: '+447700900123', status: 'completed', invited_at: dateOffset(10), completed_at: dateOffset(9), created_at: dateOffset(10), survey_link: '/survey/demo-survey-001?c=2' },
  { id: 3, name: 'Sofia Reyes', email: 'sofia@beta.io', phone: null, status: 'invited', invited_at: dateOffset(10), completed_at: null, created_at: dateOffset(10), survey_link: '/survey/demo-survey-001?c=3' },
  { id: 4, name: 'Marcus Chen', email: 'marcus@beta.io', phone: null, status: 'invited', invited_at: dateOffset(10), completed_at: null, created_at: dateOffset(10), survey_link: '/survey/demo-survey-001?c=4' },
  { id: 5, name: 'Aisha Kamara', email: 'aisha@delta.co', phone: '+19175550199', status: 'bounced', invited_at: dateOffset(10), completed_at: null, created_at: dateOffset(10), survey_link: '/survey/demo-survey-001?c=5' },
  { id: 6, name: 'Tom Bergmann', email: 'tom@delta.co', phone: null, status: 'completed', invited_at: dateOffset(10), completed_at: dateOffset(7), created_at: dateOffset(10), survey_link: '/survey/demo-survey-001?c=6' },
  { id: 7, name: 'Lena Fischer', email: 'lena@gmbh.de', phone: null, status: 'invited', invited_at: dateOffset(5), completed_at: null, created_at: dateOffset(5), survey_link: '/survey/demo-survey-001?c=7' },
